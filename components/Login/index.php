...
<html lang="es">
    <head>
        ...
        <link rel="stylesheet" href="style2.css" id="style-sheet">
    </head>
    <body>
            ...
            <form class="my-form" method="post" action="login.php">
                ...
                <div class="text-field">
                    ...
                    <img
                        alt="Password Icon"
                        title="Password Icon"
                        src="assets/bloquear.png"
                    >
                </div>
                <div class="my-form__row">
                    <span>¿Olvidaste tu contraseña?</span>
                    <a href="./NuevaPrueba1/CambiarContra/CambioContr.php" title="Reset Password">Restablecer la contraseña</a>
                </div>
